...
| --- | --- | --- | --- | --- | ---: |
| GFDL-ESM2M CMOR pipeline | Transfer corrected data to SPIRIT and DKRZ | in_progress | high | 2026-09-25 | 100 |
| Soil carbon change in TIPMIP simulations | Create documentation page for this issue | in_progress | medium | 2026-09-30 | 65 |
| Couple MEDUSA to Bern3D | Read MEDUSA&#x27;s documentation on coupling | in_progress | medium | — | 25 |
| Update Speedy version in Julia Bern3D wrapper | Implement PR changes and fixes | in_progress | medium | — | 25 |
