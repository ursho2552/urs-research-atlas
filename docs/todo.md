...
| --- | --- | --- | --- | --- | ---: |
| Document new GFDL-ESM2M CMOR pipeline | Test new bug fix for hfbasin | in_progress | high | 2026-09-21 | 80 |
...
| Soil carbon change in TIPMIP simulations | Understand how soil carbon works in GFDL-ESM2M | in_progress | medium | 2026-09-30 | 25 |
| Bern3D documentation | Extend current documentation | in_progress | low | 2026-12-31 | 15 |
| Couple MEDUSA to Bern3D | Couple Bern3D and MEDUSA with an async time-step | todo | medium | — | 15 |
| DRTSafe crash during hosing experiments | Diagnose why the crash occurs | in_progress | low | — | 15 |
| Soil carbon change in TIPMIP simulations | Derive drivers of the change | todo | medium | 2026-09-30 | 15 |
| Soil carbon change in TIPMIP simulations | Create documentation page for this issue | todo | medium | 2026-09-30 | 15 |
